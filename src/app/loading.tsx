  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      <div className="fixed top-0 left-0 right-0 h-1 z-[60] overflow-hidden">
        <div className="h-full bg-amber-600 w-full origin-left animate-progress-fast" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-white border border-slate-100 rounded-[2.5rem] p-8 space-y-6"
            >
              ...
              <div className="space-y-3">
                ...
                <div className="h-5 w-2/3 bg-slate-100 rounded-lg animate-pulse" />
              </div>
              <div className="pt-4">
