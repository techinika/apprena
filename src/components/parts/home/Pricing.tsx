    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      <div className="p-10 rounded-[3rem] bg-white border-2 border-amber-600 shadow-2xl relative flex flex-col scale-105 z-10">
        ...
        <div className="text-5xl font-black mb-8 text-slate-900">
          $0.99
          <span className="text-sm text-slate-400 font-normal"> /analysis</span>
        </div>
        <ul className="space-y-4 mb-10 flex-grow">
          {[
        ...
        <button className="w-full py-5 rounded-2xl font-black bg-amber-600 text-white hover:bg-amber-700 transition-all shadow-xl shadow-amber-200 uppercase text-xs tracking-widest">
          Unlock Analysis
        </button>
      </div>
      ...
      <div className="p-10 rounded-[3rem] bg-slate-900 text-white flex flex-col">
        ...
        <button className="w-full py-4 rounded-2xl font-black bg-white text-slate-900 hover:bg-amber-50 transition-all uppercase text-xs tracking-widest">
          Subscribe
        </button>
      </div>
    </div>
